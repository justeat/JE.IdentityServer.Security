...
namespace JE.IdentityServer.Security.Tests.Extensions
{
    public class ExtractClientIpFromOwinContext
    {
        ...
        [TestCase("X-Forwarded-For", "192.168.100.1", ExpectedResult = "192.168.100.1")]
        ...
        [TestCase("X-Forwarded-For", "192.168.100.1, 192.168.200.101", ExpectedResult = "192.168.100.1")]
